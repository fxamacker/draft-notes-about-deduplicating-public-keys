...
- ### RLE++ Encoding (I don't know if I'm the first person to invent this encoding)
  - I named it RLE++ because it adds a feature to RLE ([run-length encoding](https://en.wikipedia.org/wiki/Run-length_encoding)) that also allows efficient encoding of non-repeating values.
